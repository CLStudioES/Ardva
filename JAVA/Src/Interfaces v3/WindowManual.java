...
public class WindowManual extends JFrame {
	...
	public WindowManual() {
		...
		btnAutomatico.setBounds(662, 467, 121, 23);
		...
		btnManual.setBounds(563, 467, 89, 23);
		...
		JButton btnRele4On = new JButton("Fan 2- ON");
		...
		JButton btnRele4Off = new JButton("Fan 2- OFF");
		...
		btnRefrescar.setFont(new Font("Berlin Sans FB", Font.PLAIN, 15));
		btnRefrescar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			}
		});
		btnRefrescar.setBounds(613, 79, 121, 46);
