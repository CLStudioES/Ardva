	...
	public WindowManual(PanamaHitek_Arduino ino) {
		...
		btnManual.addActionListener(new ActionListener() {
			...
			try{
				...
				atm.executeUpdate("INSERT INTO domotica (Estancia, Temperatura, Humedad, Consumo) VALUES ('0', '" + textField_1.getText() + "', '" + textField_2.getText() + "', '" + textField_3.getText() + "'); ");
				atm.executeUpdate("INSERT INTO domotica (Estancia, Temperatura, Humedad, Consumo) VALUES ('1', '" + textField_4.getText() + "', '" + textField_5.getText() + "', '" + textField_6.getText() + "'); ");
			}
